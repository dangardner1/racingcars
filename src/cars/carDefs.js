 ...
 * aggression/skill/topSpeed drive AIController behavior for AI-piloted cars.
 */
export const CAR_DEFS = [
  {
    id: 'bolt', name: 'Bolt', color: 0x2299ee,
    chassisSize: [1.3, 0.4, 0.7], wheelBase: 1.8, mass: 40,
    aggression: 0.5, skill: 0.7, topSpeed: 14,
  },
  {
